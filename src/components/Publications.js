    ...
    <div id="publicationSection" className="relative scroll-mt-16">
      ...
      <div className="container m-auto px-7 lg:px-10 xl:px-20 2xl:px-28 3xl:px-44 pt-8 md:pt-16">
        <div className="">
          ...
          <p className="text-[#606060] text-sm ">For a complete list of my research works, please look up my <a className="text-blue-500" href="https://scholar.google.com/citations?hl=en&user=oesQCGUAAAAJ">Google Scholar</a>.</p>
        </div>
